...
const handleChange = (e) => {
	...
	function handleSubmit(e) {
      ...
      <br />
          ...
          <h2 className="register-member">Organisation Profile</h2>
          <br />
      <br />
                ...
                <span>
								...
								<div>
									<button type="submit" className="btn10" >Save Changes</button>
									<Link to="/Password">
										<button type="submit" className="btn101" >Update Password</button>
										</Link>
								</div>
